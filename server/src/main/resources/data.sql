...
INSERT INTO auctions (id, item_id, seller_id, start_price, current_price, min_bid_increment,
                      start_time, end_time, status, current_leader, bid_count) VALUES
('AUC-01','i-001','u-sel-01', 35000000,35000000, 500000, DATE_ADD(NOW(),INTERVAL 1 DAY), DATE_ADD(NOW(),INTERVAL 7 DAY),'OPEN',    NULL,      0),
('AUC-02','i-002','u-sel-01',  5000000, 6000000, 100000, DATE_SUB(NOW(),INTERVAL 1 DAY), DATE_ADD(NOW(),INTERVAL 3 DAY),'RUNNING', 'bidder3', 3),
('AUC-03','i-004','u-sel-02', 25000000,25000000, 200000, DATE_SUB(NOW(),INTERVAL 2 DAY), DATE_ADD(NOW(),INTERVAL 5 MINUTE),'RUNNING',NULL,    0),
('AUC-04','i-005','u-sel-01', 15000000,18000000, 500000, DATE_SUB(NOW(),INTERVAL 5 DAY), DATE_SUB(NOW(),INTERVAL 1 DAY),'FINISHED','bidder2', 2);
